        ...
        React.createElement("div", { className: "max-w-7xl mx-auto space-y-8 mt-4 lg:mt-0" },
            React.createElement(GlassCard_1.GlassCard, { className: "lg:p-8 md:p-6 p-6 bg-white/80 backdrop-blur-lg" },
                ...
                React.createElement(framer_motion_1.AnimatePresence, { mode: "wait" }, (selectedImage || resultImage || uploadedImage) && (React.createElement(framer_motion_1.motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: 20 }, className: "grid md:grid-cols-2 gap-8 mt-8" },
                    (selectedImage || uploadedImage) && (React.createElement("div", { className: "relative rounded-xl overflow-hidden" },
                    ...
                    isLoading ? (React.createElement("div", { className: "bg-white/80 rounded-xl shadow-lg p-8 flex items-center justify-center" },
                        React.createElement("div", { className: "flex flex-col items-center gap-4" },
                            ...
                            React.createElement("p", { className: "text-gray-600" }, "Analyzing image...")))) : (resultImage && (React.createElement("div", { className: "relative rounded-xl overflow-hidden" },
                        React.createElement(badge_1.Badge, { className: "absolute top-4 left-4 bg-[#FF8C00] text-white" }, "Result Image"),
                        React.createElement(ImagePreview_1.ImagePreview, { src: resultImage, alt: "Result preview", title: "Selected Result", sourceUrl: imageSourceUrl || undefined })))))))),
            reduxSearchResults.length > 0 && (React.createElement(framer_motion_1.motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, className: "space-y-8" },
                React.createElement("div", { className: "flex items-center justify-between" },
                    ...
                    React.createElement("div", { className: "flex items-center gap-4" },
                        selectedImages.length > 0 && (React.createElement(badge_1.Badge, { variant: "secondary", className: "bg-[#F0F4FA] text-gray-700" },
                            selectedImages.length,
                            " images selected")),
                        React.createElement(button_1.Button, { onClick: handleMoreInfoClick, disabled: selectedImages.length === 0, className: "bg-[#F0F4FA] text-gray-700 hover:bg-[#007BFF] hover:text-white transition-all duration-200 disabled:opacity-50" },
