...
function InfoPage() {
    ...
    var _b = react_1.useState(null), gptResult = _b[0], setGPTResult = _b[1];
    var _c = react_1.useState([]), apiSearchResults = _c[0], setApiSearchResults = _c[1];
    ...
    return (React.createElement("div", { className: "min-h-screen  text-slate-200 py-8 px-4 md:py-12 md:px-8" },
        React.createElement("div", { className: "max-w-7xl mx-auto" },
            React.createElement("div", { className: "flex items-center gap-4 mb-8" },
                ...
                React.createElement("h1", { className: "poppins-semibold text-primary text-3xl font-bold" }, "Deep Analysis")),
            React.createElement(GlassCard_1.GlassCard, { className: "p-8 mb-8" },
                React.createElement("div", { className: "flex justify-center mb-8" },
                    React.createElement(button_1.Button, { onClick: handleAnalyze, disabled: selectedImages.length === 0 || isLoading, className: "bg-primary text-white px-8 py-2" }, isLoading ? (React.createElement(React.Fragment, null,
